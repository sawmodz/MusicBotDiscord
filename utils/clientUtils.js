const clientHasPermissions = async (guild) => {
    ...
    if(_client.hasPermission("MANAGE_CHANNELS") && _client.hasPermission("SEND_MESSAGES") && _client.hasPermission("EMBED_LINKS") && _client.hasPermission("ADD_REACTIONS") && _client.hasPermission("CONNECT") && _client.hasPermission("SPEAK")){
        return true
    }else{
        const invite = "https://discord.com/oauth2/authorize?client_id=858492022217637949&scope=bot&permissions=3165264&guild_id="
